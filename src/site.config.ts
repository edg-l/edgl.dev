...
const config: SiteConfig = {
  ...
  socialLinks: {
    github: 'https://github.com/edg-l',
    email: 'edgar@edgl.dev',
    bluesky: 'https://bsky.app/profile/edg-l.bsky.social',
    twitter: 'https://x.com/edgluq',
